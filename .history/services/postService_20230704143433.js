...
const objectId = ObjectID.fromString('5f843665508c906e48d8e911');
...
exports.uploadPostImage = async (req, res, next) => {
    if(req.file != undefined) {
     ...
     const fileName = Date.now() + '-' + file.originalname; 
      ...
      req.body.image = `http://localhost:5000/uploads/images/${fileName}`;
    }
  next();
}
...
exports.createService = async (req, res, next) =>{
    ...
    req.body.userId =  ObjectID.fromString('req.userId')
    postModel
    .create(req.body)
